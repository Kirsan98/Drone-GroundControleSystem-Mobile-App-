...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener
{
    ...
    private int ratio = 1 ; // The smaller, the more shading will occur
    ...
    private void drawJoystick(float newX, float newY){
        if(getHolder().getSurface().isValid())
        {
            ...
            myCanvas.drawColor(Color.WHITE); // Set the BG color
            ...
            float sin = newY-centerY / hypotenuse; // sin = 0/h
            float cos = newX-centerX / hypotenuse; // cos =4/h
            colors.setARGB(255,100,100,100); // Color of joystick base
            ...
            for(int i=0; i <= (int) (baseRadius/ ratio) ; i++) {
                ...
                myCanvas.drawCircle(newX, newY, hatRadius - (float) i * (ratio) / 2, colors); // Draw tha shading for the hat
            }
